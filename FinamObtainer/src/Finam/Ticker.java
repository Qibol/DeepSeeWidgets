...
/**
 * Cache' Java Class Generated for class Finam.Ticker on version Cache for UNIX (SUSE Enterprise Server for x86-64) 2012.1.2 (Build 702U) Fri May 4 2012 12:42:35 EDT.<br>
 *
 * @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker</A>
**/

public class Ticker extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 2997;
    private static String CACHE_CLASS_NAME = "Finam.Ticker";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>Finam.Ticker.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "Finam.Ticker" in Cache
    ...
    * objects must be instances of <code>Finam.Ticker</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>Finam.Ticker</code> or of
      any of its subclasses. Cast to <code>Finam.Ticker</code> is
     ...
     *
     * <code>
     * CandidateKey key = Finam.Ticker.createCodeIndexKey(db);
     * key.set(value);
     * </code>
     *
    ...
    * to open all instances of class Finam.Ticker
    ...
    */
    ...
    /**
       Returns class name of the class Finam.Ticker as it is in
   ...
   */
    ...
    /**
       ...
       @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#Code"> Code</A>
    */
    public java.lang.String getCode()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("Code",false);
       return dh.getString();
    }
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#Cost"> Cost</A>
    */
    public java.lang.Double getCost()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("Cost",false);
       return dh.getDouble();
    }
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#Title"> Title</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#hrefIO"> hrefIO</A>
    */
    public com.intersys.classes.RelationshipObject gethrefIO()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("hrefIO",true);
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%IsA"> Method %IsA</A>
    */
...
extent physical data.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%KillExtent"> Method %KillExtent</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeDisplayToLogical"> Method CodeDisplayToLogical</A>
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIndexDelete"> Method CodeIndexDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIndexExists"> Method CodeIndexExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIndexOpen"> Method CodeIndexOpen</A>
    */
    public static Finam.Ticker CodeIndexOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIndexOpen"> Method CodeIndexOpen</A>
    */
    public static Finam.Ticker CodeIndexOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"CodeIndexOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIndexOpen"> Method CodeIndexOpen</A>
    */
    public static Finam.Ticker CodeIndexOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeIsValid"> Method CodeIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CodeLogicalToDisplay"> Method CodeLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CostDisplayToLogical"> Method CostDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CostIsValid"> Method CostIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#CostLogicalToDisplay"> Method CostLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#FindTicker"> Method FindTicker</A>
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static Finam.Ticker IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static Finam.Ticker IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static Finam.Ticker IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#TitleDisplayToLogical"> Method TitleDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#TitleIsValid"> Method TitleIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#TitleLogicalToDisplay"> Method TitleLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#hrefIOGetObject"> Method hrefIOGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#hrefIOGetObjectId"> Method hrefIOGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://ip-10-62-94-107.eu-west-1.compute.internal:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=FINANCE&CLASSNAME=Finam.Ticker#hrefIOIsValid"> Method hrefIOIsValid</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "Finam.Ticker_Extent", 0, 0);
    }

    public static Object addToBatchInsert (Object batch, java.sql.Connection con, String cos_Code, Double cos_Cost, String cos_Title) throws java.sql.SQLException {
        if (batch == null) {
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("Finam", "Ticker", 4, batch, con, nolock);
